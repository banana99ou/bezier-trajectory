...
figures, in [`doc/notes/004_probabilistic_koz/main.tex`](doc/notes/004_probabilistic_koz/) —
...
**Figure duplication to resolve.** `doc/notes/004_probabilistic_koz/` (fig1–fig3 +
