...
|---:|---:|---:|---:|---:|---:|---:|---:|
| 6 | 7 | 16 | 성공 | TODO | TODO | TODO | TODO |
| 7 | 8 | 16 | 성공 | TODO | TODO | TODO | TODO |
| 8 | 9 | 16 | 성공 | TODO | TODO | TODO | TODO |

> 표의 측정 수치(안전 여유·제어 비용·계산 시간·반복 횟수)는 optimizer 루프 재작업 이후 재생성 예정 (TODO).
...
|---:|---:|---:|---:|---:|---:|
| 2 | 실패 | TODO | TODO | TODO | TODO |
| 4 | 성공 | TODO | TODO | TODO | TODO |
| 8 | 성공 | TODO | TODO | TODO | TODO |
| 16 | 성공 | TODO | TODO | TODO | TODO |
| 32 | 성공 | TODO | TODO | TODO | TODO |
| 64 | 성공 | TODO | TODO | TODO | TODO |

> 표의 측정 수치(안전 여유·제어 비용·계산 시간·반복 횟수)는 optimizer 루프 재작업 이후 재생성 예정 (TODO).

분할이 지나치게 거친 경우에는 명제 1의 조건을 만족하는 제어점 배치가 경계조건과 양립하기 어려워진다. 명제 1은 충분조건이므로 조건이 성립하면 회피는 보장되지만, 조건이 만족될 수 있는 영역이 좁아지면 하위 문제는 여유 변수가 0이 아닌 해를 내놓고 그 해는 KOZ를 침범할 수 있다. 즉 이 경우의 실패는 충분조건의 타당성에서 오는 것이 아니라 그 조건이 정의하는 영역의 크기에서 온다.
...
|---:|---:|---:|---:|---:|---:|---:|
| 6 | 7 | 16 | 성공 | TODO | TODO | TODO |
| 7 | 8 | 16 | 성공 | TODO | TODO | TODO |
| 8 | 9 | 16 | 성공 | TODO | TODO | TODO |

> 표의 측정 수치(안전 여유·제어 비용·계산 시간)는 optimizer 루프 재작업 이후 재생성 예정 (TODO).
