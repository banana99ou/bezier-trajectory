...
- [ ] 초록과 서론 앞부분의 non-claim 문장(`direct collocation 대비 우월성 미주장`, `전역 최적성 미주장` 등)을 어디까지 전면에 둘지 다시 검토할 것.
- [ ] `warm start`와 후속 solver 관련 위치 설정을 방법론의 핵심 기여와 어떻게 분리해 제시할지 재정리할 것.
