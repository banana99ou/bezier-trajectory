# Paper Quality Rubric

Use this rubric to evaluate whether the paper is coherent, scientifically defensible, well-positioned, and adequately supported by evidence.
...
- `4`: strong
- `5`: very strong / submission-ready
...
Are the definitions, assumptions, formulations, approximations, and optimization choices correct and internally consistent?

### 5. Evidence Fit

Does each major claim have matching evidence? Are experiments, derivations, ablations, and qualitative explanations sufficient for what is being claimed?

### 6. Comparison Fairness

Are baselines appropriate, fairly framed, and evaluated under a defensible comparison setup?
