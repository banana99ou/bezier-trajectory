...
- The L1 and L2 objectives provide meaningful alternative surrogates.
...
4. A short, honest subsection explaining the L1 and L2 objective modes without ranking them by unsupported physical meaning.
5. A clearly written limitations section that states what the current paper does not prove.
